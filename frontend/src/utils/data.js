...
export const FEATURES = [
  ...
  },
  {
    title: "Smart Library",
    description:
      "Store, search, and organize all your writing projects with ease in your personal digital library.",
    icon: Library,
  ...
  },
  {
    ...
    description:
      "Organize all your ebook projects in a personal dashboard. Track progress, edit drafts, and manage versions easily.",
    icon: Library,
...
export const TESTIMONIALS = [
  ...
  {
    quote:
      "The one-click export feature saved me so much time. I was able to publish my ebook on multiple platforms without hassle!",
    author: "Peter Jones",
