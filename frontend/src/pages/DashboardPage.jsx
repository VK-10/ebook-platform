...
// skeleton loader for the book card
const BookCardSkeleton = () => {
  <div className="animate-pulse bg-white border-slate-200 rounded-lg shadow-sm">
...
const DashboardPage = () => {
  ...
  const handleDeleteBook = async () => {
    ...
    try {
      ...
      setBooks(books.fileter((book) => book._id !== bookToDelete));
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed border-slate-200 rounded-xl mt-8">
            ...
            <p className="text-slate-500 mb-6 max-w-md">
              You havent created any eBooks yet. Get started by creating your fisrt one.
            </p>
