    ...
    <div className='group relative bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-xl hover:shadow-gray-100/50 hover:-translate-y-1 cursor-pointer ' onClick={() => navigate(`/view-book/${book._id}`)}>
      <div className='relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100'>
        ...
        <div className='absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-2'>
          ...
          >
            <Trash2 className='w-4 h-4 text-red-500 group-hove/deleter:text-red-600'/>
          </button>
        </div>
      </div>
      ...
      <div className='absolute bottom-0 left-0 right-0 p-5 text-white'>
        ...
        <div className='relative'>
          <h3 className='font-semibold text-white text-sm leading leading-tight line-clamp-2 mb-1'>
            {book.title}
          </h3>
