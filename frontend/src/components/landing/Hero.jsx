    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative">
        <div className = "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-xl space-y-8">
                ...
                <h1 className="text-xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading tight tracking-tight">
                    Create Stunning 
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                    From idea to Publishing, AI powere platform helps you in writing, desgining and export professional-quality books effortless
                </p>

                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <Link to={isAuthenticated ? "/dashboard" : "/login"} className="">
                    <span className="group inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200">Start Creating for free</span>
        ...
        <div className="realtive lg:pl-8">
            <div className="relative">
                ...
                <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                    ...
                    <div className="absolute top-6 right-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fase-in slide-in-from-right duration-700">
                        <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg flex items-center justify-center">
                                <Zap className="w-5 h-5 text-w"/>
                            </div>
                            <div>
