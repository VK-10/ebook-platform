      ...
      <div className="max-w-7xl mx-auto lg:px-8 relative">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Our platform is packed with powerful features to help you write, design and publish your
            ebook effortlessly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-transparent to-transparent group-hover:from-violet-50 group-hover:to-purple-50/30 transition-all duration-300" />

                <div className="relative space-y-4">
                  <div
                    className={`w-14 h-14 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 ${feature.gradient}`}
                    aria-hidden
                  >
