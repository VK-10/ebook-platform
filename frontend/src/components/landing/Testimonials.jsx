...
const Testimonials = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-96 h-64 bg-violet-200/20 rounded-full blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-violet-50/0 to-purple-50/0 group-hover:from-violet-50/50 group-hover:to-purple-50/30 rounded-3xl transition-all duration-300 -z-10"></div>
            </div>
          ))}
        </div>
